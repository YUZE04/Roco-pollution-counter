...
class App:
    ...
    def build_settings_ui(self):
        ...
        target_w = max(560, int(self.normal_size[0]))
        target_h = min(max(380, int(self.normal_size[1])), 420)
        self.normal_size = (target_w, target_h)
        self.set_window_size(target_w, target_h)
        ...
        tk.OptionMenu(row6, self.resolution_var, "1920x1080", "2560x1440", "2560x1600_150缩放").pack(side="left")
        ...
        bottom_box.pack(fill="x", pady=(10, 0), anchor="n")
        ...
        tk.Label(
            ...
            wraplength=max(280, self.normal_size[0] - 80),
            justify="center"
        ).pack(pady=(2, 0))
    ...
    def _apply_running_window_mode(self):
        enabled = bool(self.config_data.get("game_mode_no_activate", True)) and bool(self.running)
        try:
