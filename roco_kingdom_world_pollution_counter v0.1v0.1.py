...
DEFAULT_CONFIG = {
    ...
    "scan_interval": 0.7,
    "confirm_frames": 1,
    "window": {"x": 60, "y": 60, "width": 500, "height": 360},
...
class App:
    ...
    def on_root_configure(self, _event=None):
        try:
            if self.in_compact_mode:
                ...
                w = max(420, int(self.root.winfo_width()))
                h = max(320, int(self.root.winfo_height()))
    ...
    def build_settings_ui(self):
        ...
        tk.Scale(
            row5, from_=0.0, to=1.0, resolution=0.01, orient="horizontal", length=140,
